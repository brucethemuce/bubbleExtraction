...
# plt.title("0.7 scfh (65 Bins), 2 minutes, 80ms Sampling")
# plt.tight_layout()
# plt.savefig('hist.jpg',dpi=300)

# plt.title("0.7 scfh (65 Bins), 4 minutes, 80ms Sampling")
# plt.tight_layout()
# plt.savefig('hist4.jpg',dpi=300)

# plt.title("0.7 scfh (65 Bins), 4 minutes, 40ms Sampling")
# plt.tight_layout()
# plt.savefig('hist4_40.jpg',dpi=300)

# plt.title("0.7 scfh (65 Bins), 4 minutes, 20ms Sampling")
# plt.tight_layout()
